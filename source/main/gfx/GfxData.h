...
struct Prop
{
    ...
    uint16_t              pp_node_ref             = NODENUM_INVALID;
    uint16_t              pp_node_x               = NODENUM_INVALID;
    uint16_t              pp_node_y               = NODENUM_INVALID;
...
struct VideoCamera
{
    ...
    uint16_t             vcam_node_center    = NODENUM_INVALID;
    uint16_t             vcam_node_dir_y     = NODENUM_INVALID;
    uint16_t             vcam_node_dir_z     = NODENUM_INVALID;
    uint16_t             vcam_node_alt_pos   = NODENUM_INVALID;
    uint16_t             vcam_node_lookat    = NODENUM_INVALID; //!< Only for VCTYPE_TRACK_CAM
...
struct NodeGfx
{
    ...
    uint16_t   nx_node_idx = NODENUM_INVALID;
...
struct Rod
{
    ...
    uint16_t         rod_node1           = NODENUM_INVALID;  //!< Node index - may change during simulation!
    uint16_t         rod_node2           = NODENUM_INVALID;  //!< Node index - may change during simulation!
