...
void registerOgreRadian(AngelScript::asIScriptEngine *engine)
{
	...
	r = engine->RegisterObjectMethod("radian", "float opImplCast() const",                asMETHOD(Radian,valueRadians), asCALL_THISCALL); MYASSERT( r >= 0 );
	r = engine->RegisterObjectMethod("radian", "double opImplCast() const",               asMETHOD(Radian,valueRadians), asCALL_THISCALL); MYASSERT( r >= 0 );
...
void registerOgreDegree(AngelScript::asIScriptEngine *engine)
{
	...
	// Register other object behaviours
	r = engine->RegisterObjectMethod("degree", "float opImplCast() const",                asMETHOD(Degree,valueDegrees), asCALL_THISCALL); MYASSERT( r >= 0 );
	r = engine->RegisterObjectMethod("degree", "double opImplCast() const",               asMETHOD(Degree,valueDegrees), asCALL_THISCALL); MYASSERT( r >= 0 );
