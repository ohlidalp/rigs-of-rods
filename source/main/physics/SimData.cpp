...
const char* RoR::ActorSimAttrToString(ActorSimAttr attr)
{
    ...
    // Extcamera
    case ACTORSIMATTR_EXTCAMERA_MODE:                    return "ACTORSIMATTR_EXTCAMERA_MODE";
    case ACTORSIMATTR_EXTCAMERA_NODE:                    return "ACTORSIMATTR_EXTCAMERA_NODE";
    case ACTORSIMATTR_EXTCAMERA_SMOOTHING:               return "ACTORSIMATTR_EXTCAMERA_SMOOTHING";
    case ACTORSIMATTR_EXTCAMERA_ANTIJITTER:              return "ACTORSIMATTR_EXTCAMERA_ANTIJITTER";
