...
public:
    ...
    Ogre::Vector3     GetCameraDir()                    { return (ar_nodes_hot[ar_main_camera_node_pos].RelPosition - ar_nodes_hot[ar_main_camera_node_dir].RelPosition).normalisedCopy(); }
    Ogre::Vector3     GetCameraRoll()                   { return (ar_nodes_hot[ar_main_camera_node_pos].RelPosition - ar_nodes_hot[ar_main_camera_node_roll].RelPosition).normalisedCopy(); }
    ...
    node_hot_t*          ar_nodes_hot = nullptr;
