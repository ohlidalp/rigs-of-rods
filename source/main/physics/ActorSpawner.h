...
private:
    ...
    BeamID_t                      AddWheels2RimBeam(RigDef::DataPos_t pos, node_t *node_1, node_t *node_2);
    BeamID_t                      AddWheels2TyreBeam(RigDef::DataPos_t pos, node_t *node_1, node_t *node_2);
    BeamID_t                      AddWheels2Beam(RigDef::DataPos_t pos, node_t *node_1, node_t *node_2);
