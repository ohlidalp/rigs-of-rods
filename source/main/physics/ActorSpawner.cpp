...
void ActorSpawner::ProcessHook(DataPos_t pos)
{
    ...
    if (def.flag_no_rope)
    {
        m_actor->ar_beams[hook->hk_beam].bounded = SpecialBeam::NOSHOCK; // regular beam.
    }
...
BeamID_t ActorSpawner::AddWheels2RimBeam(DataPos_t pos, node_t* node_1, node_t* node_2)
{
    BeamID_t beam_index = AddWheels2Beam(pos, node_1, node_2);
...
BeamID_t ActorSpawner::AddWheels2TyreBeam(DataPos_t pos, node_t* node_1, node_t* node_2)
{
    BeamID_t beam_index = AddWheels2Beam(pos, node_1, node_2);
    beam_t& beam = GetBeam(beam_index);
...
BeamID_t ActorSpawner::AddWheels2Beam(DataPos_t pos, node_t* node_1, node_t* node_2)
{
